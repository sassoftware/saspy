...
class TestSASdataObject(unittest.TestCase):
    ...
    def test_SASdata(self):
        ...
        expected = '<section data-name="SGPlot" data-sec-type="proc">'
        self.assertIsInstance(ll, dict, msg="cars.hist(...) didn't return dict")
        self.assertGreater(len(ll['LST']), 20000, msg="cars.hist(...) result were too short")
        ...
        self.assertGreater(len(ll['LST']), 20000, msg="cars.heatmap(...) result were too short")
